...
if GetIsGUIMonitor() == QTS_MONITOR_BINARY or  GetIsGUIMonitor() == QTS_MONITOR_BOTH :
	...
	AppendPropertyForMonitor(1,QTS_CFG_KEY_EXCHANGE,'e.qts.gui')
	AppendPropertyForMonitor(1,QTS_CFG_KEY_QUEUE,'q.qts.gui.binary')
	AppendPropertyForMonitor(1,QTS_CFG_KEY_ROUTINGKEY,'r.qts.gui.binary')
