#coding=utf-8
############################################
#本文件是GUI系统的入口置文件，用QGOnuca应用程序起动，
...
InitRunEnv(QTS_CONVERT_CFG_FILE,QTS_APP_MODE_SINGLE,QTS_APP_PY_VERSION,release,True,True,QTS_MONITOR_NONE,QTS_MONITOR_NONE,QTS_MONITOR_NONE,
		QTS_MONITOR_NONE,loadertype=QTS_LOADER_TYPE,backuptype=qts_all_file)
#设置是否打印所有的python输出
SetIsPrint(False)
...
#*******************************************************************************
#模块导入
sys.path.append('{0}/console/convert'.format(GetCfgPath()))
from qtsconvert import *
#*******************************************************************************