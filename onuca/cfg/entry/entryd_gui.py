...
#*******************************************************************************
#设置单程序启动的程序名称
SetStartApp(QTS_CFG_APP_GUI_NAME)
#初始化运行环境，参数是入口配置模块
#参数1：设置缺省的主模块
...
InitRunEnv(QTS_GUI_CFG_FILE,QTS_APP_MODE_SINGLE,QTS_APP_PY_VERSION,debug,True,True,QTS_MONITOR_NONE,QTS_MONITOR_NONE,QTS_MONITOR_NONE,
