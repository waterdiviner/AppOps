...
InitRunEnv(QTS_SS_CFG_FILE,QTS_APP_MODE_SERVER,QTS_APP_PY_VERSION,release,True,True,QTS_MONITOR_NONE,QTS_MONITOR_NONE,QTS_MONITOR_NONE,
...
#*******************************************************************************
#用户变量自定义区，回放时间定义
SetVarInMainDict(QTS_REPLAY_START_DATE,'20150803')
SetVarInMainDict(QTS_REPLAY_END_DATE,'20150803')
