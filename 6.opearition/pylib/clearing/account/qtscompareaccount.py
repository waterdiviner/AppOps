...
class QtsCompareAccount(object) :
...
if __name__ == "__main__":
    compare = QtsCompareAccount(QTS_CSV_FLAG,'E:/QTS/2.other/data/loader/qtsexposition.pos','E:/QTS/2.other/data/loader/qtsexposition.pos')
    compare.Run()